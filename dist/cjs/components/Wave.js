...
const Wave = (props) => {
    const [ref, { width, height }] = (0, useMeasure_1.default)();
    ...
    const wavesData = (0, stacked_1.calculateStacked)(1, width, height, 0.5);
    return (react_1.default.createElement("div", { ref: ref, style: { width: '100%', height: '100%' } },
        react_1.default.createElement("svg", { viewBox: `0 0 ${width} ${height}`, height: "100%", width: "100%" },
            react_1.default.createElement("rect", { x: "0", y: "0", width: "540", height: "960", fill: "lightblue" }),
