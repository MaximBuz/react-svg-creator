...
const Wave = (props) => {
    ...
    return (React.createElement("div", { ref: ref, style: { width: '100%', height: '100%' } },
        React.createElement("svg", { viewBox: `0 0 ${size.width} ${size.height}`, height: "100%", width: "100%" },
            React.createElement("rect", { x: "0", y: "0", width: size.width, height: size.height, fill: "lightgreen" }),
